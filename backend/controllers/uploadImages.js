...
export const uploadResumeImages = async (req, res) => {
    try {
        ...
        (req, res, async (err) => {
            ...
            await resume.save();
            return res.status(200).json({ success: true, message: "Image uploaded successfully.", thumbnailLink: resume.thumbnailLink, profilePreviewUrl: resume.profileInfo.profilePreviewUrl });
        })

    } catch (err) {
        console.error("Error on uploading image from -> uploadImages.js", err);
