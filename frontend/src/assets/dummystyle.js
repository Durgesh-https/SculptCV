...
export const photoSelectorStyles = {
  ...
  hiddenInput: "hidden",
  placeholder: (hovered) =>
    `relative w-32 h-32 sm:w-36 sm:h-36 flex items-center justify-center bg-gray-50 border-2 border-dashed border-gray-300 rounded-full cursor-pointer transition-all duration-300 ${hovered ? "hover:border-violet-500 hover:bg-violet-50" : ""}`,
  cameraButton:
...
export const titleInputStyles = {
  ...
  inputField: (focused) =>
    `text-lg sm:text-xl font-bold bg-transparent outline-none text-gray-800 border-b-2 pb-2 transition-all duration-300 ${focused ? "border-violet-500" : "border-gray-300"}`,
  confirmButton:
