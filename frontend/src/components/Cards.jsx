...
import { Check, Clock, Edit, LucideTrash2, Zap } from "lucide-react";
          ...
          <div className={cardStyles.actionOverlay}>
            <div className={cardStyles.actionButtonsContainer}>
              ...
              <button
                ...
                title="Delete"
              >
                <LucideTrash2 size={18} className={cardStyles.buttonIcon} />
              </button>
            </div>
          </div>
        )}
    ...
    >
      {thumbnailImg ? (
        <div className="relative w-full h-full overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-white/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
          {isSelected && (
        ...
        <div className="w-full h-[200px] flex items-center flex-col justify-center bg-gradient-to-br from-violet-50 via-violet-600 to-fuchsia-50">
          <div className="w-12 h-12 bg-gradient-to-br from-violet-500 to-fuchsia-500 rounded-2xl flex items-center mb-3">
