...
//         >
//           <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent animate-shimer" />
//           <div className="absolute inset-0 opacity-80">
//             {[...Array(8)].map((_, i) => {
//               <div
//                 key={i}
//                 className='absolute top-1/2 w-2 h-2 bg-white rounded-full animate-bubble shadow-lg style={{
//                             left: `${(i + 1) * 12}%`,
...
//           {progress === 100 && (
//             <div className="w-6 h-6 bg-gradient-to-r from-green-500 to-emerald-500 rounded-b-full flex items-center justify-center">
